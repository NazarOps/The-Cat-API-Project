...
namespace Cat_API_Project.Services.Interfaces
{
    public interface ICatService
    {
        ...
        Task<bool> UpdateCatAsync(int id, UpdateCatDTO updateCatDTO); // return true if the update succeeded else false
        Task<bool> DeleteCatAsync(int id);  // return true if deletion succeeded else return false
    }
}
